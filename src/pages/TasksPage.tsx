...
function PlanTables({
  ...
  return (
    <div className="foremanResults">
      {along && (
        <>
          ...
          <p className="panelHint">
            ...
            заготовки та пропил ленточної між ними) — не менша за значення в таблиці. Окремі колоди
      ...
      <h3>Ленточна пилка — по висоті кругляка (торець)</h3>
      <p className="panelHint">
