/**
 * Смуга після ленточної (ширина ребра), ріжемо на дошки товщиною B з пропилом K між різами.
 ...
 * Якщо хорда з плану колоди недоступна — орієнтир для схеми нарізу на станку 2.
 */
