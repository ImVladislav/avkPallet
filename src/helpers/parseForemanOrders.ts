...
/**
 * aMm — перший розмір перетину після кількості у рядку / полі «висота»: товщина смуги з ленточної (мм).
 * bMm — другий розмір у записі бригадира (мм). Для станку 2: ширина різу поперек смуги — сторона,
...
/**
 * Ширина бруса поперек смуги на станку 2 (мм): та сторона перетину, яка не дорівнює висоті смуги th.
