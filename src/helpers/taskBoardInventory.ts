...
export type TaskBoardFromInventoryRow = {
  ...
  /** Довжини смуг, списаних у цьому записі розпилу багатопилу (мм), по одній на кожну смугу */
...
/**
 * Розгортає записи розпилу багатопилу у список окремих брусів: товщина, ширина, довжина за замовленням,
 * фактична довжина смуги (зі складу після стрічкової пили, FIFO по журналу смуг).
 */
